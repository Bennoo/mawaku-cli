...
Make the room welcoming through a comfortable seating area to one side, regionally appropriate materials and a palette drawn from the requested location. \
Choose furniture forms, upholstery and wood finishes appropriate to the local residential style; leave generous breathing room between them. \
...
Local interior identity: make the requested country, region or setting visible inside the room as well as through the exterior view. Include one distinctive wall decoration and one complementary craft object or textile grounded in that location: for example, a locally appropriate print, ceramic wall panel, woven hanging, carved wooden piece, regional pottery or patterned fabric. Select only the forms appropriate to this particular place, using the most specific regional context supplied. Describe and render their characteristic motifs, colours, materials and workmanship rather than generic decorative shapes. Place wall decoration on a side wall and the complementary piece in the middle distance, readable at webcam scale without crowding the caller's central area or the broad exterior opening. Keep the pair coherent with a lived-in home and integrated with the furniture. Use two or three local accents in total, with open space around them; avoid souvenir collections, flags and tourist-poster styling. For fictional settings, use coherent in-world decorative objects and wall art appropriate to the supplied setting.\n\n\
